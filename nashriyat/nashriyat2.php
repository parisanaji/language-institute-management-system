...
<br />
<p><div id="frame"><font size="+1"><p  align="right">متن خبر انگلیسی با ترجمه</p></font><hr />
<?php
$host="localhost";
...
$sql="select * from nashriyat where id=?";
$result=$connect->prepare($sql);
$result->bindValue(1,$_GET["id"]);
$result->execute();
foreach($result as $rows)
{
	echo "<div id=onvan><p align=center dir=rtl>".$rows["onvan"]."</p></div>";
	echo "<p align=center><img src=pic/".$rows["photo"]." /></p>";
	echo "<p><div dir=ltr id=matlab>".$rows["matnlatin"]."<br><br></div></p>";
	echo "<p><div id=matlab2>".$rows["matnfarsi"]."<br><br></div></p>";
}
?>
