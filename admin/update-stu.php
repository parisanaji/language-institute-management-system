...
<head>
<meta charset="utf-8">
<title>ویرایش اطلاعات دانش آموزان</title>
<style type="text/css">
#formcss
{
	direction:rtl;
...
?>
<div class="container" >
<center><label id="label">فرم ویرایش اطلاعات دانش آموز</label></center>
<br>
    <form action="update-stu2.php" enctype="multipart/form-data" class="form-group-sm form-inline" id="formcss">
  <p><font color="#F10A0E">*</font> 
    <label for="id" >شماره</label>
    <input type="text" name="id" class="form-control form-group"  readonly id="id" value=<?php echo $rows["id"]; ?>>
  ...
  <center><a href="update-stu2.php"><input type="submit" value="به روز رسانی" id="btnup" name="btnup"></a></center>
  </div>
</form>
  <?php 
}
