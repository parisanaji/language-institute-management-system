...
<br>
<div class="col_34">
<img src="../pic/41.jpg" width="700" height="470" id="img" >
</div>

 <div  class="col-lg-6" class="col-md-6"  class="col-xs-6" align="center" id="kadr" align="center"> 
 <img src="../pic/Logo.scale-100.png"> 
<form id="form1" name="form1" method="post" >
  <p>
  <div id="kadr2">ورود به پنل مدیریت </div>
  <br>
  <?php
...
if(isset($_POST["btn"]))
{
	...
	else
	{
		...
		header("location:admin_pannel.php?user=$_POST[username]");
		exit;
		}
		else
		{
