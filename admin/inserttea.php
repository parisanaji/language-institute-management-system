...
<body>
<div class="container" >
<center><label id="label">استاد جدید</label></center>
<br>
<?php
...
?>
  <center>
      ...
      <br>
      <br>
      <div align="right" id="formcss">
  </center>
  <form action="insert-tea2.php" enctype="multipart/form-data" class="form-group-sm form-inline"  id="formcss" dir="rtl">
  <p><font color="#F10A0E">*</font> 
    ...
    <input type="text" name="degree" class="form-control form-group" id="degree">
    <font color="#F10A0E">*</font> 
  ...
  <center><a href="insert-tea2.php".php"><input type="submit" value="اضافه کردن " id="btnadd" name="btnadd"></a></center>
  </div>
</form>
</body>
