...
<br>
<div class="col_34">
<img src="../pic/teacher-course.jpg" width="500" height="470" id="img" >
</div>

 <div  class="col-lg-6" class="col-md-6"  class="col-xs-6" align="center" id="kadr" align="center"> 
 <img src="../pic/teacher_logo.jpg"> 
<form id="form1" name="form1" method="post" >
  <p>
  <div id="kadr2">ورود به پنل اساتید</div>
  <br>
  <?php
...
if(isset($_POST["btn"]))
{
	...
	else
	{
		...
		if($nums!=0)
		{
		$_SESSION["tea-login"]=1;
		header("location:tea.pannel.php?user=$_POST[username]");
		exit;
		}
		else
		{
...
<script src="../bootstrap/js/jquery.form.js">
