...
{
	$sql3="SELECT * FROM `students` WHERE `id`=?";
...
if(isset($_GET["reply"]))
{
echo "<td><img src=../pic/Generic.Theme-Light_Scale-300.png width=20 height=20 onClick=click()></td>";
}
else
{
	echo "<td><a href=repmessage.php?id=".$rows2["id"]."&sendid=".$_GET["id"]."><img src=../pic/Generic.Theme-Light_Scale-300.png width=20 height=20></td>";
}
