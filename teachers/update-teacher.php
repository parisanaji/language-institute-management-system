...
<br>
<br>
    <form action="update-teacher2.php" enctype="multipart/form-data" class="form-group-sm form-inline" id="formcss">
 ...
 <?php 
 echo'<center><a href=update-teacher2.php?id='.$rows["id"].'><input type=submit value="به روز رسانی" id=btnup name=btnup></a></center>';
  ?>
  </div>
</form>
</center>
